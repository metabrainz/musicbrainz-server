            ...
            media => [
                {
                    ...
                    id => '596a290f-cf94-4d63-ae82-8dcbacd7db6a',
                    title => '',
                    position => 1,
                    'track-count' => 0,
                },
            ...
            media => [
                {
                    format => 'CD',
                    'format-id' => '9712d52a-4509-3d4b-a1a2-67c88c643e31',
                    id => '09af1de4-a712-4bfb-8331-fb15f6fcd844',
                    title => '',
                    position => 1,
                    'track-offset' => 0,
                    'track-count' => 3,
            ...
            media => [
                {
                    format => 'CD',
                    'format-id' => '9712d52a-4509-3d4b-a1a2-67c88c643e31',
                    id => '18d49785-59f6-4698-99bc-43aa0043abd9',
                    title => '',
                    position => 1,
                    discs => [
                        {
...
test 'release lookup, related artists have no tags/genres' => sub {
    ...
    => {
        ...
        media => [ {
            format => 'CD',
            'format-id' => '9712d52a-4509-3d4b-a1a2-67c88c643e31',
            id => '7a5e9a3b-6587-489a-bf68-83ce04bafaea',
            title => '',
            'track-count' => 10,
            'track-offset' => 0,
            position => 1,
...
test 'MBS-7914' => sub {
    ...
    '/release/a3ea3821-5955-4cee-b44f-4f7da8a332f7?inc=artists+media+recordings+artist-credits+aliases' => {
        ...
        media => [{
            format => JSON::null,
            'format-id' => JSON::null,
            id => '74093abc-1b12-447e-9444-87c4b91e236e',
            position => 1,
            title => '',
            'track-count' => 1,
            'track-offset' => 0,
        ...
        media => [
            {
                format => JSON::null,
                'format-id' => JSON::null,
                id => '5e7cebc3-6a7a-494d-8d04-d95361c02b76',
                position => 1,
                title => '',
                'track-count' => 1,
                'track-offset' => 0,
            ...
            media => [
                {
                    format => 'CD',
                    'format-id' => '9712d52a-4509-3d4b-a1a2-67c88c643e31',
                    id => '613fb5fc-7581-409e-9676-9b926aa8ad12',
                    position => 1,
                    title => '',
                    'track-count' => 1,
                    'track-offset' => 0,
