    ...
    '/artist?release=aff4a693-5970-4e2e-bd46-e2ee49c22de7&inc=tags+genres+ratings' =>
        {
            ...
            artists => [
                ...
                },
                {
                    ...
                    genres => [
                        { count => 1, id => 'eba7715e-ee26-4989-8d49-9db382955419', name => 'j-pop' },
                        { count => 1, id => 'b74b3b6c-0700-46b1-aa55-1f2869a3bd1a', name => 'k-pop' },
                        { count => 1, id => '911c7bbb-172d-4df8-9478-dbff4296e791', name => 'pop' },
                        ],
                    ipis => [],
                    isnis => [],
                    gender => JSON::null,
