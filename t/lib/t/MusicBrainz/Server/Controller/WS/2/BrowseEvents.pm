...
test all => sub {
    ...
    ws2_test_xml 'browse events via multiple events (cycle)',
        '/event?event=0fcf8392-c3fd-485e-8919-bd4bf9872ff9' .
            '&event=c188cfc1-725d-496b-b7f1-b0258573508b' .
            '&event=8b918af8-c275-42e3-858b-2098ea307208' .
            '&inc=event-rels' => <<~"XML";
        <?xml version="1.0" encoding="UTF-8"?>
        <metadata xmlns="http://musicbrainz.org/ns/mmd-2.0#">
            <event-list count="3">
