...
ws_test 'label lookup with ratings',
    ...
    '<?xml version="1.0" encoding="UTF-8"?><metadata xmlns="http://musicbrainz.org/ns/mmd-1.0#"><label id="46f0f4cd-8aab-4b33-b698-f459faf64190" type="OriginalProduction"><name>Warp Records</name><sort-name>Warp Records</sort-name><label-code>2070</label-code><country>GB</country><life-span begin="1989" /><rating votes-count="1">100</rating></label></metadata>';
...
<metadata xmlns="http://musicbrainz.org/ns/mmd-1.0#">
  <label id="fe03671d-df66-4984-abbc-bd022f5c6c3f" type="OriginalProduction">
    <name>RAM Records</name><sort-name>RAM Records</sort-name><country>GB</country><life-span begin="1992" />
...
ws_test 'label lookup with release-relationships',
 ...
 <name>Atlantic</name>
 <sort-name>Atlantic</sort-name><label-code>121</label-code>
 <country>US</country><life-span begin="1947" />
...
ws_test 'label lookup with ratings',
    ...
    '<?xml version="1.0" encoding="UTF-8"?><metadata xmlns="http://musicbrainz.org/ns/mmd-1.0#"><label id="46f0f4cd-8aab-4b33-b698-f459faf64190" type="OriginalProduction"><name>Warp Records</name><sort-name>Warp Records</sort-name><label-code>2070</label-code><country>GB</country><life-span begin="1989" /><user-rating>5</user-rating></label></metadata>',
   { username => 'editor', password => 'password' };
