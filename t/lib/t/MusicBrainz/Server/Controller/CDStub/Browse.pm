...
$mech->content_like(qr/Added 14 years ago/, 'content has added timestamp');
$mech->content_like(qr/last modified 13 years ago/, 'content has last modified timestamp');
