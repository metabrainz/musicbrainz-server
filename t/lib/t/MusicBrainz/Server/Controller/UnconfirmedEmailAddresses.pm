...
@unconfirmed_email_whitelist = (
  ...
  'Controller::ISRC::load',
  'Controller::ISRC::show',
  'Controller::ISWC::load',
  ...
  'Controller::MetaBrainz::base',
  'Controller::MetaBrainz::oauth2_callback',
  'Controller::MetaBrainz::webhook_callback',
  ...
  'Controller::Root::toggle_legacy_browser',
  ...
  'Controller::WS::js::find_possible_spammers',
  'Controller::WS::js::mark_spammer',
