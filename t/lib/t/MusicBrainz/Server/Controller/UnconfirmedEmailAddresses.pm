...
@unconfirmed_email_whitelist = (
  ...
  'Controller::Mood::alias',
  'Controller::Mood::aliases',
  'Controller::Mood::annotation_diff',
  'Controller::Mood::annotation_history',
  'Controller::Mood::annotation_revision',
  'Controller::Mood::base',
  'Controller::Mood::details',
  'Controller::Mood::edits',
  'Controller::Mood::latest_annotation',
  'Controller::Mood::list',
  'Controller::Mood::open_edits',
  'Controller::Mood::show',
  ...
  'Controller::WS::2::Mood::base',
  'Controller::WS::2::Mood::mood_all',
  'Controller::WS::2::Mood::mood_search',
