...
INSERT INTO artist (id, gid, name, sort_name, last_updated, edits_pending, comment)
  VALUES (3, '159cb1fa-dbe9-4777-abf6-7ecb3ce84f91', 1, 1, now(), 0, 'Artist 1'),
         (4, 'fbbf7950-eebe-49e5-86d6-058ecc2bf4ac', 1, 1, now(), 10, 'Artist 2');
...
UPDATE artist SET last_updated = '1970-01-01' WHERE id = 3;

SELECT set_eq(
  'SELECT * FROM empty_artists()',
  ARRAY[ 3 ]
);

--------------------------------------------------------------------------------
-- Artists with edits pending are not eligible for empty_artists()
UPDATE artist SET edits_pending = edits_pending + 1 WHERE id = 3;
SELECT set_eq(
  'SELECT * FROM empty_artists()', '{}'::INT[]
);
...
INSERT INTO l_artist_artist (id, entity0, entity1, link) VALUES (1, 3, 3, 1);
SELECT set_eq(
  'SELECT * FROM empty_artists()', '{}'::INT[]
);
...
INSERT INTO l_artist_label (id, entity0, entity1, link) VALUES (1, 3, 1, 1);
SELECT set_eq(
  'SELECT * FROM empty_artists()', '{}'::INT[]
);
...
INSERT INTO l_artist_recording (id, entity0, entity1, link) VALUES (1, 3, 1, 1);
SELECT set_eq(
  'SELECT * FROM empty_artists()', '{}'::INT[]
);
...
--------------------------------------------------------------------------------
-- l_artist_recording entries exclude artists from empty_artists()
INSERT INTO l_artist_release (id, entity0, entity1, link) VALUES (1, 3, 1, 1);
SELECT set_eq(
  'SELECT * FROM empty_artists()', '{}'::INT[]
);
...
INSERT INTO l_artist_release_group (id, entity0, entity1, link) VALUES (1, 3, 1, 1);
SELECT set_eq(
  'SELECT * FROM empty_artists()', '{}'::INT[]
);
...
INSERT INTO l_artist_url (id, entity0, entity1, link) VALUES (1, 3, 1, 1);
SELECT set_eq(
  'SELECT * FROM empty_artists()', '{}'::INT[]
);
...
INSERT INTO l_artist_work (id, entity0, entity1, link) VALUES (1, 3, 1, 1);
SELECT set_eq(
  'SELECT * FROM empty_artists()', '{}'::INT[]
);
...
INSERT INTO edit_artist (edit, artist) VALUES (1, 3);
SELECT set_eq(
  'SELECT * FROM empty_artists()', '{}'::INT[]
);
...
SELECT set_eq(
  'SELECT * FROM empty_artists()', '{3}'::INT[]
);
