...
INSERT INTO artist (id, gid, name, sort_name)
  VALUES (1, '82ac9811-db47-4c05-9792-83cf4208afd0', 1, 1),
         (2, '9baea67a-8d86-422d-b653-b0f6d0a93c7c', 1, 1);
...
DELETE FROM artist_tag WHERE tag = 4;
INSERT INTO artist_tag (artist, tag, count) VALUES (1, 4, 1);

DELETE FROM artist_tag WHERE tag = 5 AND artist = 1;
