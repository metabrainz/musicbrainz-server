INSERT INTO editor (id, name, password, privs, email, website, bio, member_since, email_confirm_date, last_login_date, ha1) VALUES
    (1, 'autoeditor1', '{CLEARTEXT}password', 1, 'autoeditor1@email.com', 'http://test.website', 'biography', '1989-07-23', '2005-10-20', now(), 'deea5e52f725bc948b235708ae795c0d'),
    (2, 'autoeditor2', '{CLEARTEXT}password', 1, 'autoeditor2@email.com', 'http://test.website', 'biography', '1989-07-23', '2005-10-20', now(), '83a90735621cd5c21135844a765cada6'),
    (3, 'autoeditor3', '{CLEARTEXT}password', 1, 'autoeditor3@email.com', 'http://test.website', 'biography', '1989-07-23', '2005-10-20', now(), 'a6b5ec377150ddfe23fbe4e852b3ff10'),
