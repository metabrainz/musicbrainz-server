...
INSERT INTO link_type (id, parent, child_order, gid, entity_type0, entity_type1, name, description, link_phrase, reverse_link_phrase, long_link_phrase, last_updated, is_deprecated, has_dates, entity0_cardinality, entity1_cardinality) VALUES
--    (74, 73, 1, '98e08c20-8402-4163-8970-53504bb6a1e4', 'release', 'url', 'purchase for download', 'This is used to link to a page where the release can be purchased for download.', 'purchase for download', 'download purchase page for', 'can be purchased for download at', '2013-12-10 13:51:19.794106+00', false, true, 0, 0),
--    (85, 73, 3, '08445ccf-7b99-4438-9f9a-fb9ac18099ee', 'release', 'url', 'streaming music', 'This relationship type is used to link a release to a site where the tracks can be legally streamed for free, e.g. Spotify.', 'stream {video} for free', 'free music {video} streaming page for', '{video} can be streamed for free at', '2014-01-19 02:56:04.116246+00', false, true, 0, 0),
    ...
    (666, 188, 0, 'baf4b924-088c-41b3-8b49-7a4d1d5f3be9', 'artist', 'url', 'musicmoz', 'This links an artist to its MusicMoz page', 'MusicMoz', 'MusicMoz page for', 'has a MusicMoz page at', '2017-09-11 04:00:09.052103+00', false, false, 0, 0),
    -- We want this to be deprecated and have zero uses
    (667, 188, 0, 'baf4b924-088c-41b3-8b49-7a4d1d5f3be8', 'artist', 'url', 'deleted', 'This relationship type has been deprecated and has zero uses', 'deleted', 'deleted', 'deleted', '2017-09-11 04:00:09.052103+00', true, false, 0, 0);
...
INSERT INTO release_label (id, release, label, catalog_number, last_updated) VALUES
    (1237936, 1693299, 62565, NULL, '2016-01-26 21:00:23.940303+00');
