...
INSERT INTO release_group (id, gid, name, artist_credit) VALUES
    (1, '3ca028a0-3c88-43cc-943d-d9ce1bade7a7', 'Aerial', 1);
INSERT INTO release (id, gid, name, release_group, artist_credit) VALUES
    (1, '8c2a1f4e-e11a-4261-a0f4-d1039ef94745', 'Aerial', 1, 1),
    (2, '37b58375-019f-4ffb-8360-9c4b11d087b8', 'Aerial', 1, 1);
INSERT INTO medium (id, gid, release, track_count, position) VALUES
    (1, 'db285540-e162-48e3-949d-bfe342426ffc', 1, 0, 1),
    (2, 'bf0472f2-383f-4e35-adb6-46ac0e60ae7b', 2, 0, 1);
...
INSERT INTO track (id, gid, medium, position, number, recording, name, artist_credit, length) VALUES (3, 'f891acda-39d6-4a7f-a9d1-dd87b7c46a0a', 1, 3, 3, 1, 'The same track over and over', 1, NULL);
...
INSERT INTO track (id, gid, medium, position, number, recording, name, artist_credit, length) VALUES (8, 'c05b1c9a-e768-4c8d-b2b6-c687060c8f1e', 2, 1, 1, 1, 'The same track over and over', 1, NULL);
INSERT INTO track (id, gid, medium, position, number, recording, name, artist_credit, length) VALUES (9, 'dcfefa46-e689-4877-b535-d617cdb7616c', 2, 2, 2, 1, 'The same track over and over', 1, NULL);
INSERT INTO track (id, gid, medium, position, number, recording, name, artist_credit, length) VALUES (10, '94364964-9557-4a7c-8373-c4796a5905cb', 2, 3, 3, 1, 'The same track over and over', 1, NULL);
INSERT INTO track (id, gid, medium, position, number, recording, name, artist_credit, length) VALUES (11, '3fa99306-2c99-4173-bb3e-e86e83f1f64e', 2, 4, 4, 1, 'The same track over and over', 1, NULL);
