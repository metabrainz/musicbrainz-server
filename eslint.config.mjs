...
export default [
  ...
  },
  {
    files: [
      ...
      'root/static/scripts/external-links-editor/components/ExternalLinkAttributeDialog.js',
      ...
      'root/static/scripts/external-links-editor/components/UrlRelationshipCreditFieldset.js',
