...
or use someone else's available search instance.

In either case, you will need to change `SEARCH_SERVER` in lib/DBDefs.pm to
point to the instance you want to use.
