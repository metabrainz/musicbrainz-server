...
import {type WorkAttributeTypeEditFormT} from './types.js';

component WorkAttributeTypeEditForm(
  ...
  return (
    <form method="post">
      ...
      <FormRowCheckbox
        ...
        label="This is a free text work attribute"
        uncontrolled
      />
...
export default WorkAttributeTypeEditForm;
