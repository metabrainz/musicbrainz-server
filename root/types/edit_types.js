...
declare type AddRelationshipEditT = $ReadOnly<{
  ...GenericEditT,
  +display_data: {
    +entity0?: CentralEntityT,
    +entity1?: CentralEntityT,
...
declare type AddRelationshipTypeEditT = $ReadOnly<{
  ...
  +display_data: {
    ...
    +entity0_type: CentralEntityTypeT,
    +entity1_cardinality?: number,
    +entity1_type: CentralEntityTypeT,
    +link_phrase: string,
...
declare type AddRemoveAliasEditGenericT = $ReadOnly<{
  ...GenericEditT,
  +display_data: {
    +[coreEntityType: CentralEntityTypeT]: CentralEntityT,
    +alias: string,
    +begin_date: PartialDateT,
    +end_date: PartialDateT,
    +ended?: boolean,
    +entity_type: CentralEntityTypeT,
    +locale: string | null,
