...
module.exports = {
  ...
  'components/AreaList': require('../components/AreaList'),
  'components/ArtistList': require('../components/ArtistList'),
  'components/EventList': require('../components/EventList'),
  'components/ExpirationTime': require('../components/ExpirationTime'),
  'components/InstrumentList': require('../components/InstrumentList'),
  'components/LabelList': require('../components/LabelList'),
  'components/PlaceList': require('../components/PlaceList'),
  'components/RecordingList': require('../components/RecordingList'),
  'components/Relationships': require('../components/Relationships'),
  'components/ReleaseGroupList': require('../components/ReleaseGroupList'),
  'components/ReleaseList': require('../components/ReleaseList'),
  'components/SeriesList': require('../components/SeriesList'),
  'components/UserAccountTabs': require('../components/UserAccountTabs'),
  'components/WorkList': require('../components/WorkList'),
