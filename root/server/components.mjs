...
export default {
  ...
  'instrument/CreateInstrument': (): Promise<mixed> => import('../instrument/CreateInstrument.js'),
  'instrument/DeleteInstrument': (): Promise<mixed> => import('../instrument/DeleteInstrument.js'),
  'instrument/EditInstrument': (): Promise<mixed> => import('../instrument/EditInstrument.js'),
  ...
  'static/scripts/edit/components/StandaloneFormRowTextListSimple': (): Promise<mixed> => import('../static/scripts/edit/components/StandaloneFormRowTextListSimple.js'),
