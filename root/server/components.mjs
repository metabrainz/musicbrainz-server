...
export default {
  ...
  'report/ArtistsWithOddPrimaryAlias': (): Promise<mixed> => import('../report/ArtistsWithOddPrimaryAlias.js'),
  ...
  'report/LabelsWithOddPrimaryAlias': (): Promise<mixed> => import('../report/LabelsWithOddPrimaryAlias.js'),
