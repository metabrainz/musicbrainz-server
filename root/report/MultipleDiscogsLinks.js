...
const MultipleDiscogsLinks = ({
  ...
  <Layout fullWidth title={l('Releases with multiple Discogs links')}>
    ...
    <ul>
      <li>{l('This report shows releases that have more than one link to \
              ...
              releases too.',
              {__react: true, release_group: '/doc/Release_Group'})}
      </li>
...
export default withCatalystContext(MultipleDiscogsLinks);
