...
const CollaborationRelationships = ({
  ...
  return (
    <Layout fullWidth title={l('Artists with collaboration relationships')}>
      ...
      <ul>
        <li>{l('This report lists artists which have collaboration relationships but no URL relationships. \
         ...
         "X with Y" or "X & Y", you should probably split it. See {how_to_split_artists|How to Split Artists}.',
          {__react: true, how_to_split_artists: '/doc/How_to_Split_Artists'})}
        </li>
