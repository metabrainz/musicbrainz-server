...
const UnlinkedPseudoReleases = ({
  ...
  <Layout fullWidth title={l('Unlinked pseudo-releases')}>
    ...
    <ul>
      <li>{l('This report shows releases with status Pseudo-Release that aren\'t linked \
              via the translation/transliteration relationship to an original version. \
              This could be because the original version is missing, or just because \
              the release status is wrongly set.')}
      </li>
