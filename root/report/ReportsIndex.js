    ...
    <Layout fullWidth title={l_reports('Reports')}>
      <div id="content">
        ...
        <ul>
          ...
          />
          <ReportsIndexEntry
            content={l_reports('Artists with mismatched primary aliases')}
            reportName="ArtistsWithMismatchedPrimaryAliases"
          />
        </ul>

        <h2>{l_mb_server('Artist credits')}</h2>
        ...
        <ul>
          ...
          />
          <ReportsIndexEntry
            content={l_reports('Labels with mismatched primary aliases')}
        ...
        <ul>
          ...
          />
          <ReportsIndexEntry
            content={l_reports('Release groups without any releases')}
        ...
        <ul>
          ...
          />
          <ReportsIndexEntry
            content={l_reports('Suspiciously early digital releases')}
            reportName="ReleasedTooEarlyDigital"
          />
          <ReportsIndexEntry
            content={l_reports('Releases older than their release label')}
        ...
        <ul>
          ...
          />
          <ReportsIndexEntry
            content={l_reports('Recordings with possible duplicate works')}
          ...
          <ReportsIndexEntry
            content={l_reports(
              'Recordings marked as both karaoke and instrumental',
            )}
        ...
        <ul>
          ...
          />
          <ReportsIndexEntry
            content={l_reports('Series containing duplicates')}
