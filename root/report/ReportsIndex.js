    ...
    <Layout fullWidth title={l('Reports')}>
      <div id="content">
        ...
        <ul>
          ...
          />
          <ReportsIndexEntry
            content={l('Artists with odd primary aliases')}
            reportName="ArtistsWithOddPrimaryAlias"
          />
        </ul>
        ...
        <ul>
          ...
          />
          <ReportsIndexEntry
            content={l('Labels with odd primary aliases')}
            reportName="LabelsWithOddPrimaryAlias"
          />
        </ul>
