...
const ReleasesWithCAANoTypes = ({
  ...
  <Layout fullWidth title={l('Releases in the Cover Art Archive where no cover art piece has types')}>
    ...
    <ul>
      <li>{l('This report shows releases which have cover art in the Cover Art Archive, \
        but where none of it has any types set. This often means a front cover was added, \
...
export default withCatalystContext(ReleasesWithCAANoTypes);
