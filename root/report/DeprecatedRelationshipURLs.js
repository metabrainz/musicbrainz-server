...
const DeprecatedRelationshipURLs = ({
  ...
  <Layout fullWidth title={l('URLs with deprecated relationships')}>
    ...
    <ul>
      <li>{l('This report lists URLs which have relationships using deprecated and grouping-only relationship types')}
      </li>
      <li>{l('Total URLs found: {count}', {__react: true, count: pager.total_entries})}</li>
