    ...
    <li key={'example-' + index}>
      {exp.l(
        ...
        ),
        {
          entity0: (
            <DescriptiveLink
              entity={example.relationship.source}
            />
          ),
          entity1: (
            <DescriptiveLink
              entity={example.relationship.target}
            />
          ),
        },
      )}
  ...
  return (
    <>
      ...
      <table className="details add-relationship-type">
        ...
        {entity0CardinalityChanges /*:: === true */ ? (
          <FullChangeDiff
        ...
        {entity1CardinalityChanges /*:: === true */ ? (
          <FullChangeDiff
            label={addColon(exp.l('Cardinality of {entity_placeholder}', {
              entity_placeholder: <code>{'{entity1}'}</code>,
            }))}
        ...
        {orderableDirectionChanges /*:: === true */ ? (
          <FullChangeDiff
