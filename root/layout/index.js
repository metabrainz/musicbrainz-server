...
component AnniversaryBanner() {
  ...
  const registrationDateObject = new Date(registrationDate);
  const registrationYear = registrationDateObject.getUTCFullYear();
  const comparisonDate = new Date(registrationDateObject);
