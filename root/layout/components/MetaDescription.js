...
function entityDescription(entity: CentralEntityT) {
  const desc = [];
...
function pushTypeName(desc: Array<string>, entity: CentralEntityT) {
...
const getEntityName =
  (x: {+entity: CentralEntityT, ...}): string => x.entity.name;
