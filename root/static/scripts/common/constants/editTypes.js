...
export const EDIT_MOOD_CREATE: EDIT_MOOD_CREATE_T = 170;
export const EDIT_MOOD_EDIT: EDIT_MOOD_EDIT_T = 171;
export const EDIT_MOOD_DELETE: EDIT_MOOD_DELETE_T = 172;
// 173 reserved for EDIT_MOOD_MERGE if ever implemented
export const EDIT_MOOD_ADD_ANNOTATION: EDIT_MOOD_ADD_ANNOTATION_T = 174;
export const EDIT_MOOD_ADD_ALIAS: EDIT_MOOD_ADD_ALIAS_T = 175;
export const EDIT_MOOD_DELETE_ALIAS: EDIT_MOOD_DELETE_ALIAS_T = 176;
export const EDIT_MOOD_EDIT_ALIAS: EDIT_MOOD_EDIT_ALIAS_T = 177;
