...
function ARSearch() {
	 ...
	 * @param index
	 */
	this.writeUI = function(attr, index) {
	/*
		...
		document.write('id="attr_' + attr + '_' + index + '_substr" value="Search..." onFocus="this.handleFocus(this);" ');
		document.write('title="Search for a ' + attr + ' attribute" /><input type="button" class="relationshipAttributeButton" ');
		document.write('name="attr_' + attr + '_' + index + '_findnext" id="attr_' + attr + '_' + index + '_findnext" value="&raquo;" onClick="this.findNext(this)" ');
		document.write('title="Find next ' + attr + ' matching the search string" /><input type="button" class="relationshipAttributeButton" ');
		document.write('name="attr_' + attr + '_' + index + '_remove" id="attr_' + attr + '_' + index + '_remove" value="Remove" onClick="this.removeAttribute(this)" ');
	...
	this.setupForm = function(e) {
		...
		for (var i=0; i<list.length; i++) {
			...
			if ((m = id.match(/attr_(instrument|vocal)_(\d+)/)) != null) {
				...
				s.push('id="attr_' + attr + '_' + index + '_findprev" value="&laquo;" onClick="arsearch.findPrev(this)" ');
				s.push('title="Find previous ' + attr + ' matching the search string" /><input ');
				s.push('type="text" class="relationshipAttributeField" size="6" name="attr_' + attr + '_' + index + '_substr" ');
				s.push('id="attr_' + attr + '_' + index + '_substr" value="Search..." onFocus="arsearch.handleFocus(this);" ');
				s.push('title="Search for a ' + attr + ' attribute" /><input type="button" class="relationshipAttributeButton" ');
				s.push('name="attr_' + attr + '_' + index + '_findnext" id="attr_' + attr + '_' + index + '_findnext" value="&raquo;" onClick="arsearch.findNext(this)" ');
				s.push('title="Find next ' + attr + ' matching the search string" /><input type="button" class="relationshipAttributeButton" ');
				s.push('name="attr_' + attr + '_' + index + '_remove" id="attr_' + attr + '_' + index + '_remove" value="Remove" onClick="arsearch.removeAttribute(this)" ');
				s.push('style="display: '+(index == 0 ? 'none' : 'inline') + '" title="Remove this ' + attr + '" /> ');
				if (index == 0) {
				...
				el.name = "attr_"+type+"_"+index+"_substr";
				el.id = "attr_"+type+"_"+index+"_substr";
				el.setAttribute("size", 6);
				el.title = "Search for "+type;
				parent.appendChild(el);
				el.onfocus = function(e) { arsearch.handleFocus(this); };
				...
				el.type = "button";
				el.className = "relationshipAttributeButton";
				el.name = "attr_"+type+"_"+index+"_remove";
				el.id = "attr_"+type+"_"+index+"_remove";
				el.value = "Remove";
...
/*
				...
				document.write('title="Find previous ' + attr + ' matching the search string" /><input ');
				document.write('type="text" class="ar-attr-textfield" size="6" name="attr_' + attr + '_' + index + '_substr" ');
				document.write('id="attr_' + attr + '_' + index + '_substr" value="Search..." onFocus="this.onFocus(this);" ');
				document.write('title="Search for a ' + attr + ' attribute" /><input type="button" class="relationshipAttributeButton" ');
				document.write('name="attr_' + attr + '_' + index + '_findnext" id="attr_' + attr + '_' + index + '_findnext" value="&raquo;" onClick="this.findNext(this)" ');
				document.write('title="Find next ' + attr + ' matching the search string" /><input type="button" class="relationshipAttributeButton" ');
				document.write('name="attr_' + attr + '_' + index + '_remove" id="attr_' + attr + '_' + index + '_remove" value="Remove" onClick="this.removeAttribute(this)" ');
...
var arsearch = new ARSearch();
mb.registerDOMReadyAction(
	new MbEventAction(arsearch.GID, 'setupForm', "Setup AdvancedRelationship Search")
);
