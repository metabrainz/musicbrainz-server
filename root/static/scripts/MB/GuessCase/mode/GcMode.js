/*----------------------------------------------------------------------------\
  ...
  |                                                                             |
  | $Id: GcMode.js 9120 2007-05-10 12:08:35Z luks $
  \----------------------------------------------------------------------------*/
...
function GcMode(modes, name, lang, desc, url) {
	...
	return !(this._modes.EN == this.getLanguage());
    };
	...
	return gc.u.inArray(this.lowerCaseWords,w);
	...
	return this.runFixes(is, gc.re.PREPROCESS_COMMONS);
    };
	...
	return this.runFixes(is, gc.re.PREPROCESS_FIXLIST);
    };
