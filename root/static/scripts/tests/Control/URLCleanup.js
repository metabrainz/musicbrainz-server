...
limited_link_type_combinations: [
  ...
  // VK
  {
             ...
             input_entity_type: 'artist',
    expected_relationship_type: 'socialnetwork',
            expected_clean_url: 'https://vk.ru/tin_sontsya',
  },
  {
                     input_url: 'http://www.vk.ru/silentwoogoore',
             input_entity_type: 'artist',
    expected_relationship_type: 'socialnetwork',
            expected_clean_url: 'https://vk.ru/silentwoogoore',
  },
  {
                     input_url: 'https://vk.com/audio-2001235442_109235442',
             input_entity_type: 'recording',
    expected_relationship_type: 'streamingfree',
            expected_clean_url: 'https://vk.ru/audio-2001235442_109235442',
       only_valid_entity_types: ['recording'],
  },
  {
             ...
             input_entity_type: 'release',
    expected_relationship_type: 'streamingfree',
            expected_clean_url: 'https://vk.ru/music/album/-2000201522_14201522',
       only_valid_entity_types: ['release'],
  },
  {
                     input_url: 'https://m.vk.ru/audio?act=audio_playlist-2000201522_14201522',
             input_entity_type: 'release',
    expected_relationship_type: 'streamingfree',
            expected_clean_url: 'https://vk.ru/music/album/-2000201522_14201522',
       only_valid_entity_types: ['release'],
  },
  {
             ...
             input_entity_type: 'release',
    expected_relationship_type: 'streamingfree',
            expected_clean_url: 'https://vk.ru/music/album/-2000595165_15595165',
       only_valid_entity_types: ['release'],
  },
  {
             ...
             input_entity_type: 'artist',
    expected_relationship_type: 'streamingfree',
            expected_clean_url: 'https://vk.ru/artist/shortparis',
       only_valid_entity_types: ['artist'],
  },
  {
                     input_url: 'https://vk.ru/artist/khleb?z=video-2000471995_63471995',
             input_entity_type: 'recording',
    expected_relationship_type: 'streamingfree',
            expected_clean_url: 'https://vk.ru/video-2000471995_63471995',
       only_valid_entity_types: ['recording'],
  },
  // vkdb
  {
