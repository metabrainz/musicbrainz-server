...
const URL_SHORTENERS = [
  ...
  {host: 'adf.ly', blockHost: false},
  {host: 'album.link', blockHost: false},
  {host: 'ampl.ink', blockHost: false},
  ...
  {host: 'bitly.com', blockHost: false},
  {host: 'backl.ink', blockHost: false},
  {host: 'bruit.app', blockHost: false},
  {host: 'bstlnk.to', blockHost: false},
  {host: 'cli.gs', blockHost: false},
  {host: 'deck.ly', blockHost: false},
  {host: 'distrokid.com', blockHost: false},
  {host: 'ditto.fm', blockHost: false},
  {host: 'eventlink.to', blockHost: false},
  {host: 'fanlink.to', blockHost: false},
  {host: 'ffm.to', blockHost: false},
  {host: 'found.ee', blockHost: false},
  {host: 'fty.li', blockHost: false},
  {host: 'fur.ly', blockHost: false},
  {host: 'g.co', blockHost: false},
  ...
  {host: 'laburbain.com', blockHost: false},
  {host: 'li.sten.to', blockHost: false},
  {host: 'linkco.re', blockHost: false},
  {host: 'lnkfi.re', blockHost: false},
  {host: 'linktr.ee', blockHost: false},
  {host: 'listen.lt', blockHost: false},
  {host: 'lnk.bio', blockHost: false},
  {host: 'lnk.co', blockHost: false},
  {host: 'lnk.site', blockHost: false},
  {host: 'lnk.to', blockHost: false},
  {host: 'lsnto.me', blockHost: false},
  {host: 'many.link', blockHost: false},
  {host: 'mcaf.ee', blockHost: false},
  {host: 'moourl.com', blockHost: false},
  {host: 'music.indiefy.net', blockHost: false},
  {host: 'musics.link', blockHost: false},
  {host: 'mylink.page', blockHost: false},
  {host: 'myurls.bio', blockHost: false},
  {host: 'odesli.co', blockHost: false},
  {host: 'orcd.co', blockHost: false},
  {host: 'owl.ly', blockHost: false},
  {host: 'page.link', blockHost: false},
  {host: 'pandora.app.link', blockHost: false},
  {host: 'podlink.to', blockHost: false},
  {host: 'pods.link', blockHost: false},
  {host: 'push.fm', blockHost: false},
  {host: 'rb.gy', blockHost: false},
  {host: 'rubyurl.com', blockHost: false},
  {host: 'share.amuse.io', blockHost: true},
  {host: 'smarturl.it', blockHost: false},
  {host: 'snd.click', blockHost: false},
  {host: 'song.link', blockHost: false},
  {host: 'songwhip.com', blockHost: false},
  {host: 'spinnup.link', blockHost: false},
  {host: 'spoti.fi', blockHost: false},
  {host: 'sptfy.com', blockHost: false},
  {host: 'spread.link', blockHost: false},
  {host: 'streamerlinks.com', blockHost: false},
  {host: 'streamlink.to', blockHost: false},
  {host: 'su.pr', blockHost: false},
  {host: 't.co', blockHost: false},
  {host: 'tiny.cc', blockHost: false},
  {host: 'tinyurl.com', blockHost: false},
  {host: 'tourlink.to', blockHost: false},
  {host: 'trac.co', blockHost: false},
  {host: 'u.nu', blockHost: false},
  {host: 'unitedmasters.com', blockHost: false},
  {host: 'untd.io', blockHost: false},
  {host: 'vyd.co', blockHost: false},
  {host: 'yep.it', blockHost: false},
