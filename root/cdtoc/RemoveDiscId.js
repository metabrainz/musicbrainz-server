  ...
  return (
    ...
    >
      ...
      <ul>
        ...
        <li>
          {exp.l(
            `You need to be certain that this disc ID was added to this
             release erroneously, since a release can have multiple valid
             disc IDs, and each disc ID can belong to more than one release.
