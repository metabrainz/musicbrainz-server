      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-6 d-flex" data-bs-aos="fade-right">
            <div className="card">
              <div className="card-body">
                <h5 className="card-title"><a href="https://community.metabrainz.org" rel="noopener noreferrer" target="_blank">Community Driven</a></h5>
          ...
          <div className="col-md-6 d-flex" data-bs-aos="fade-left">
            <div className="card">
              <div className="card-body">
                <h5 className="card-title"><a href="https://musicbrainz.org/doc/Development" rel="noopener noreferrer" target="_blank">Development</a></h5>
                <p className="card-text">
          ...
          <div className="col-md-6 d-flex" data-bs-aos="fade-right">
            <div className="card">
              <div className="card-body">
                <h5 className="card-title"><a href="https://musicbrainz.org/doc/General_FAQ#Why_would_I_need_to_use_MusicBrainz.3F_What.27s_wrong_with_Gracenote.27s_CDDB.3F" rel="noopener noreferrer" target="_blank">History</a></h5>
                <p className="card-text">
          ...
          <div className="col-md-6 d-flex" data-bs-aos="fade-left">
            <div className="card">
              <div className="card-body">
                <h5 className="card-title"><a href="https://musicbrainz.org/doc/MusicBrainz_Database" rel="noopener noreferrer" target="_blank">MusicBrainz Database</a></h5>
                <p className="card-text">
          ...
          <div className="col-md-6 d-flex" data-bs-aos="fade-left">
            <div className="card">
              <div className="card-body">
                <h5 className="card-title"><a href="https://musicbrainz.org/doc/Editing_FAQ" rel="noopener noreferrer" target="_blank">Varied and Never Ending</a></h5>
                <p className="card-text">
          ...
          <div className="col-md-6 d-flex" data-bs-aos="fade-left">
            <div className="card">
              <div className="card-body">
                <h5 className="card-title"><a href="https://musicbrainz.org/doc/How_Editing_Works" rel="noopener noreferrer" target="_blank">Editing Philosophy</a></h5>
                <p className="card-text">
