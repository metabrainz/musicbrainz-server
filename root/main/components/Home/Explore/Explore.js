              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  ...
                  encyclopedia of music information.              
                   ...
                   favorite artists and their works.
                  `)}
                </p>
              </div>
            </div>
          ...
          <div className="col-md-6 d-flex" data-bs-aos="fade-left">
            <div className="card">
              <div className="card-body">
                ...
                <p className="card-text">
                  {l(`If you have a digital music
                   collection, MusicBrainz Picard
                  will help you tag your files.

                  If you are a developer, our developer
                  resources will help you in
                   making use of our data.

                  If you are a commercial user, our live
                   data feed will provide
                   your local database with
                   replication packets to keep it in sync.
                  `)}
                </p>
              </div>
            </div>
          ...
          <div className="col-md-6 d-flex" data-bs-aos="fade-left">
            <div className="card">
              <div className="card-body">
                ...
                <p className="card-text">
                  {l(`The MusicBrainz Database stores
                  all of the various pieces
                   of information we collect about music,
                    from artists and their
                    releases to works and their composers,
                     and much more.
                  Most of the data in the MusicBrainz
            ...
            <div className="card">
              <div className="card-body">
                ...
                <p className="card-text">
                  ...
                  MusicBrainz exists only to collect as
                  much information about music as we can.
                  We do not discriminate or prefer one
                   &quot;type&quot; of music over another,
                   and we try to collect information about
                    as many different types of music as possible.
                    Whether it is published or unpublished,
                     popular or fringe, western or non-western,
                     human or non-human — we want it all in
                      MusicBrainz.
                      `)}
                </p>
              </div>
          ...
          <div className="col-md-6 d-flex" data-bs-aos="fade-left">
            <div className="card">
              <div className="card-body">
                ...
                <p className="card-text">
                  {l(`Maintaining a comprehensive database of all
                   types of music is a large task,
                  and MusicBrainz depends on its users to spot
                  mistakes in the database and then
                  to take the initiative to correct these errors.
                   To help with that task the
                   MusicBrainz editing and voting system was designed,
                    it gives MusicBrainz users
                    the ability to update and maintain the database
