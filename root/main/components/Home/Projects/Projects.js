            ...
            <div className="container">
                ...
                <div className="row content align-items-center">
                    <div className="col-md-5 adjust-size" data-bs-aos="fade-right">
                        <a href="https://listenbrainz.org" target="_blank" rel="noopener noreferrer"><img src="../../../../static/images/meb-logos/listenbrainz.svg" style={{height: "120px"}} className="img-fluid" alt=""/></a>
                    </div>
                ...
                <div className="row content align-items-center">
                    <div className="col-md-5 order-1 order-md-2 adjust-size" data-bs-aos="fade-left">
                        <a href="https://picard.musicbrainz.org" target="_blank" rel="noopener noreferrer"><img src="../../../../static/images/meb-logos/picard.svg" style={{height: "120px"}} className="img-fluid" alt=""/></a>
                    </div>
                ...
                <div className="row content align-items-center">
                    <div className="col-md-5 adjust-size" data-bs-aos="fade-right">
                        <a href="https://acousticbrainz.org" target="_blank" rel="noopener noreferrer"><img src="../../../../static/images/meb-logos/acousticbrainz.svg" style={{height: "120px"}} className="img-fluid adjust-size" alt=""/></a>
                    </div>
                ...
                <div className="row content align-items-center">
                    <div className="col-md-5 order-1 order-md-2 adjust-size" data-bs-aos="fade-left">
                        <a href="https://coverartarchive.org" target="_blank" rel="noopener noreferrer"><img src="../../../../static/images/meb-logos/coverartarchive.svg" style={{height: "120px"}} className="img-fluid adjust-size" alt=""/></a>
                    </div>
                    <div className="col-md-7 pt-5 order-2 order-md-1" data-bs-aos="fade-right">
                ...
                <div className="row content align-items-center">
                    <div className="col-md-5 adjust-size" data-bs-aos="fade-right">
                        <a href="https://critiquebrainz.org" target="_blank" rel="noopener noreferrer"><img src="../../../../static/images/meb-logos/critiquebrainz.svg" style={{height: "120px"}} className="img-fluid adjust-size" alt=""/></a>
                    </div>
                    <div className="col-md-7 pt-5" data-bs-aos="fade-left">
                ...
                <div className="row content align-items-center">
                    <div className="col-md-5 order-1 order-md-2 adjust-size" data-bs-aos="fade-left">
                        <a href="https://bookbrainz.org" target="_blank" rel="noopener noreferrer"><img src="../../../../static/images/meb-logos/bookbrainz.svg" style={{height: "120px"}} className="img-fluid adjust-size" alt=""/></a>
                    </div>
                    <div className="col-md-7 pt-5 order-2 order-md-1" data-bs-aos="fade-right">
