      ...
      <div className="new-homepage">
        ...
        <div className="info-container" id="about">
          <div className="row">
            ...
            <div className="col-12 col-sm-4 d-flex flex-column gap-5" id="about-news-container">
              <div>
                <h3>{l('Latest News')}</h3>
                {blogEntries?.length ? (
                  <ul className="list-unstyled">
        ...
        {/* Logo container */}
        <div className="d-flex py-5 px-5 justify-content-between align-items-center gap-4 flex-wrap logo-container">
        <a
