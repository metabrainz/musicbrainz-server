...
(
   ...
   ExchangeMetadata =>
      [\&QuerySupport::ExchangeMetadata, 
        ...
        '/rdf:RDF/rdf:Description/DC:Format/@length',
        '/rdf:RDF/rdf:Description/DC:Identifier/@audioSha1',
        '/rdf:RDF/rdf:Description/DC:Format/@sampleRate',
        '/rdf:RDF/rdf:Description/DC:Format/@bitRate',
        '/rdf:RDF/rdf:Description/DC:Format/@stereo',
        '/rdf:RDF/rdf:Description/DC:Format/@vbr'],
   #SubmitTrack =>
