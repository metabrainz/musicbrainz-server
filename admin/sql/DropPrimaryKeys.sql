...
ALTER TABLE artist_deletion DROP CONSTRAINT artist_deletion_pkey;
...
ALTER TABLE artist_isni DROP CONSTRAINT artist_isni_pkey;
...
ALTER TABLE edit_place DROP CONSTRAINT edit_place_pkey;
...
ALTER TABLE editor_subscribe_label_deleted DROP CONSTRAINT editor_subscribe_label_deleted_pkey;
...
ALTER TABLE l_area_place DROP CONSTRAINT l_area_place_pkey;
...
ALTER TABLE l_artist_place DROP CONSTRAINT l_artist_place_pkey;
...
ALTER TABLE l_label_place DROP CONSTRAINT l_label_place_pkey;
...
ALTER TABLE l_place_place DROP CONSTRAINT l_place_place_pkey;
ALTER TABLE l_place_recording DROP CONSTRAINT l_place_recording_pkey;
ALTER TABLE l_place_release DROP CONSTRAINT l_place_release_pkey;
ALTER TABLE l_place_release_group DROP CONSTRAINT l_place_release_group_pkey;
ALTER TABLE l_place_url DROP CONSTRAINT l_place_url_pkey;
ALTER TABLE l_place_work DROP CONSTRAINT l_place_work_pkey;
...
ALTER TABLE label_deletion DROP CONSTRAINT label_deletion_pkey;
...
ALTER TABLE label_isni DROP CONSTRAINT label_isni_pkey;
...
ALTER TABLE link_attribute_credit DROP CONSTRAINT link_attribute_credit_pkey;
ALTER TABLE link_attribute_type DROP CONSTRAINT link_attribute_type_pkey;
ALTER TABLE link_creditable_attribute_type DROP CONSTRAINT link_creditable_attribute_type_pkey;
...
ALTER TABLE place_alias DROP CONSTRAINT place_alias_pkey;
ALTER TABLE place_alias_type DROP CONSTRAINT place_alias_type_pkey;
ALTER TABLE place_annotation DROP CONSTRAINT place_annotation_pkey;
ALTER TABLE place_gid_redirect DROP CONSTRAINT place_gid_redirect_pkey;
ALTER TABLE place_tag DROP CONSTRAINT place_tag_pkey;
ALTER TABLE place_tag_raw DROP CONSTRAINT place_tag_raw_pkey;
...
ALTER TABLE release_country DROP CONSTRAINT release_country_pkey;
...
ALTER TABLE work_attribute_type DROP CONSTRAINT work_attribute_type_pkey;
ALTER TABLE work_attribute_type_allowed_value DROP CONSTRAINT work_attribute_type_allowed_value_pkey;
