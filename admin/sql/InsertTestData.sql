...
INSERT INTO link_attribute_type (id, root, parent, child_order, gid, name, description) VALUES
    (5, 5, NULL, 0, '58ed5e16-411a-4676-a6f9-0d8a25823763', 'ordering',
        'This attribute indicates the number of a work in a series.'
    ),
    (6, 5, 5, 0, '795daee5-fdcd-4b4b-a440-922b5e5f2aee', 'catalog number',
     'This attribute indicates the catalog number of a work in a series.'
    ),
    (7, 5, 5, 1, '05ddb0ad-fa4b-4a23-8c05-7017fc21f1b3', 'part number',
     'This attribute indicates the part number of a work in a series.'
    );

INSERT INTO link_text_attribute_type VALUES (5), (6), (7);
...
INSERT INTO series (id, gid, name, comment, type, ordering_attribute, ordering_type)
    VALUES (1, 'a8749d0c-4a5a-4403-97c5-f6cd018f8e6d', 'Test Recording Series', 'test comment 1', 1, 7, 1),
           (2, '2e8872b9-2745-4807-a84e-094d425ec267', 'Test Work Series', 'test comment 2', 2, 6, 2),
           (3, 'dbb23c50-d4e4-11e3-9c1a-0800200c9a66', 'Dumb Recording Series', '', 1, 7, 1);
...
ALTER SEQUENCE series_id_seq RESTART 5;
...
ALTER SEQUENCE link_id_seq RESTART 7;
ALTER SEQUENCE link_type_id_seq RESTART 7;

ALTER SEQUENCE l_artist_recording_id_seq RESTART 4;
ALTER SEQUENCE l_recording_series_id_seq RESTART 5;
