...
SELECT setval('work_attribute_name_id_seq', (SELECT MAX(id) FROM work_attribute_name));
SELECT setval('work_attribute_name_value_id_seq', (SELECT MAX(id) FROM work_attribute_name_value));
