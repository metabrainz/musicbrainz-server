...
SELECT setval('editor_subscribe_series_id_seq', (SELECT MAX(id) FROM editor_subscribe_series));
SELECT setval('event_id_seq', (SELECT MAX(id) FROM event));
SELECT setval('event_alias_type_id_seq', (SELECT MAX(id) FROM event_alias_type));
SELECT setval('event_alias_id_seq', (SELECT MAX(id) FROM event_alias));
...
SELECT setval('l_area_event_id_seq', (SELECT MAX(id) FROM l_area_event));
...
SELECT setval('l_area_series_id_seq', (SELECT MAX(id) FROM l_area_series));
...
SELECT setval('l_artist_event_id_seq', (SELECT MAX(id) FROM l_artist_event));
...
SELECT setval('l_artist_series_id_seq', (SELECT MAX(id) FROM l_artist_series));
...
SELECT setval('l_event_event_id_seq', (SELECT MAX(id) FROM l_event_event));
SELECT setval('l_event_instrument_id_seq', (SELECT MAX(id) FROM l_event_instrument));
SELECT setval('l_event_label_id_seq', (SELECT MAX(id) FROM l_event_label));
SELECT setval('l_event_place_id_seq', (SELECT MAX(id) FROM l_event_place));
SELECT setval('l_event_recording_id_seq', (SELECT MAX(id) FROM l_event_recording));
SELECT setval('l_event_release_id_seq', (SELECT MAX(id) FROM l_event_release));
SELECT setval('l_event_release_group_id_seq', (SELECT MAX(id) FROM l_event_release_group));
SELECT setval('l_event_series_id_seq', (SELECT MAX(id) FROM l_event_series));
SELECT setval('l_event_url_id_seq', (SELECT MAX(id) FROM l_event_url));
SELECT setval('l_event_work_id_seq', (SELECT MAX(id) FROM l_event_work));
...
SELECT setval('l_label_series_id_seq', (SELECT MAX(id) FROM l_label_series));
...
SELECT setval('l_place_series_id_seq', (SELECT MAX(id) FROM l_place_series));
...
SELECT setval('l_release_series_id_seq', (SELECT MAX(id) FROM l_release_series));
...
SELECT setval('release_alias_id_seq', (SELECT MAX(id) FROM release_alias));
...
SELECT setval('release_group_alias_id_seq', (SELECT MAX(id) FROM release_group_alias));
...
SELECT setval('series_type_id_seq', (SELECT MAX(id) FROM series_type));
SELECT setval('series_ordering_type_id_seq', (SELECT MAX(id) FROM series_ordering_type));
SELECT setval('series_alias_type_id_seq', (SELECT MAX(id) FROM series_alias_type));
