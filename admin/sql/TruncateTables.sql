...
TRUNCATE TABLE editor_collection_type_allowed_entity_type RESTART IDENTITY CASCADE;
...
TRUNCATE TABLE series_type_allowed_entity_type RESTART IDENTITY CASCADE;
