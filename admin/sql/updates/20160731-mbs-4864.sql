...
INSERT INTO statistics.statistic_event (date, title, link, description)
  ...
  '"Add relationship" , "Add release", "Add", "Edit" and "Remove release label" edits are now auto-edits for everyone. Additionally, the German, French and Dutch translations are available on the main server.'),
