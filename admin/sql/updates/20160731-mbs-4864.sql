...
INSERT INTO statistics.statistic_event (date, title, link, description)
  ...
  '"Add relationship" , "Add release", "Add", "Edit" and "Remove release label" edits have been made auto-edits for everyone. Additionally, the German, French and Dutch translations have been enabled on the main server.'),
