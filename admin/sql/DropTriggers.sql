...
DROP TRIGGER b_upd_artist_credit ON artist_credit;
DROP TRIGGER b_upd_artist_gid_redirect ON artist_gid_redirect;
DROP TRIGGER b_upd_artist_tag ON artist_tag;
DROP TRIGGER b_upd_cdtoc ON cdtoc;
DROP TRIGGER b_upd_clientversion ON clientversion;
DROP TRIGGER b_upd_editor ON editor;
DROP TRIGGER b_upd_isrc ON isrc;
...
DROP TRIGGER b_upd_label_gid_redirect ON label_gid_redirect;
...
DROP TRIGGER b_upd_recording_gid_redirect ON recording_gid_redirect;
DROP TRIGGER b_upd_recording_puid ON recording_puid;
...
DROP TRIGGER b_upd_release_gid_redirect ON release_gid_redirect;
...
DROP TRIGGER b_upd_release_group_gid_redirect ON release_group_gid_redirect;
...
DROP TRIGGER b_upd_url_gid_redirect ON url_gid_redirect;
...
DROP TRIGGER b_upd_work_gid_redirect ON work_gid_redirect;
