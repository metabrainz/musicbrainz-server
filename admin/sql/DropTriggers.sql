...
DROP TRIGGER a_ins_l_recording_series ON l_recording_series;
DROP TRIGGER a_upd_l_recording_series ON l_recording_series;
DROP TRIGGER a_del_l_recording_series ON l_recording_series;
DROP TRIGGER a_ins_l_release_series ON l_release_series;
DROP TRIGGER a_upd_l_release_series ON l_release_series;
DROP TRIGGER a_del_l_release_series ON l_release_series;
DROP TRIGGER a_ins_l_release_group_series ON l_release_group_series;
DROP TRIGGER a_upd_l_release_group_series ON l_release_group_series;
DROP TRIGGER a_del_l_release_group_series ON l_release_group_series;
DROP TRIGGER a_ins_l_series_work ON l_series_work;
DROP TRIGGER a_upd_l_series_work ON l_series_work;
DROP TRIGGER a_del_l_series_work ON l_series_work;
DROP TRIGGER a_upd_series ON series;
