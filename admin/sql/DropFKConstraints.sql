...
ALTER TABLE artist_deletion DROP CONSTRAINT artist_deletion_fk_last_known_name;
...
ALTER TABLE label_deletion DROP CONSTRAINT label_deletion_fk_last_known_name;
