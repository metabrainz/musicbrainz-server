...
ALTER TABLE list DROP CONSTRAINT list_fk_editor;
ALTER TABLE list_release DROP CONSTRAINT list_release_fk_list;
ALTER TABLE list_release DROP CONSTRAINT list_release_fk_release;
