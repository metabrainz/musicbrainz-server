...
ALTER TABLE edit_work_attribute DROP CONSTRAINT edit_work_attribute_fk_edit;
ALTER TABLE edit_work_attribute DROP CONSTRAINT edit_work_attribute_fk_work_attribute;
...
ALTER TABLE work_attribute DROP CONSTRAINT work_attribute_fk_work_attribute_name;
ALTER TABLE work_attribute DROP CONSTRAINT work_attribute_fk_work_attribute_name_value;
ALTER TABLE work_attribute_name_value DROP CONSTRAINT work_attribute_name_value_fk_work_attribute_name;
