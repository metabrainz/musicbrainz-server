...
ALTER TABLE work_attribute DROP CONSTRAINT work_attribute_fk_work_attribute_type_value;
ALTER TABLE work_attribute_type_value DROP CONSTRAINT work_attribute_type_value_fk_work_attribute_type;
