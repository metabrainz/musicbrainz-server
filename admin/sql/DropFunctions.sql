...
DROP FUNCTION a_del_l_recording_series();
DROP FUNCTION a_del_l_release_group_series();
DROP FUNCTION a_del_l_release_series();
DROP FUNCTION a_del_l_series_work();
...
DROP FUNCTION a_ins_l_recording_series();
DROP FUNCTION a_ins_l_release_group_series();
DROP FUNCTION a_ins_l_release_series();
DROP FUNCTION a_ins_l_series_work();
...
DROP FUNCTION a_upd_l_recording_series();
DROP FUNCTION a_upd_l_release_group_series();
DROP FUNCTION a_upd_l_release_series();
DROP FUNCTION a_upd_l_series_work();
...
DROP FUNCTION reorder_automatic_series(series_id integer);
