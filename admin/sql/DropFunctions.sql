...
DROP FUNCTION a_upd_medium_mirror();
...
DROP FUNCTION sanitize_dbmirror2_editor_data();
DROP FUNCTION sanitize_editor(e editor);
DROP FUNCTION sanitize_editor_strict(e editor);
DROP FUNCTION set_mediums_recordings_first_release_dates(medium_ids INTEGER[]);
...
DROP FUNCTION update_aggregate_rating(entity_type ratable_entity_type, entity_id INTEGER);
DROP FUNCTION update_aggregate_rating_for_raw_delete();
DROP FUNCTION update_aggregate_rating_for_raw_insert();
DROP FUNCTION update_aggregate_rating_for_raw_update();
