...
this.activateMenuItem=function(id,_8a){
if(_8a){
...
this.mouseOver=function(id,_8c){
mb.log.enter(this.GID,"mouseOver");
mb.log.trace("id: $, flag: $",id,_8c);
var obj=null;
if((obj=this.h.m[id])!=null){
var cn=obj.className;
if(_8c&&cn.indexOf("hover")==-1){
...
this.hideRelatedModsIframe=function(_92){
var obj=null;
if((obj=mb.ui.get("RelatedModsBox"))!=null){
obj.style.display=(_92?"none":"block");
}
};
...
oName=mName+".submenu";
if((obj=mb.ui.get(oName))!=null){
var _9d=this.OFFSET_LEFT+mOffsetLeft;
obj.style.left=""+_9d+"px";
this.h.sm[mName]=obj;
...
this.writeUI=function(_a0){
var s=[];
s.push("<table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tr>");
for(var i=0;i<this.items.length;i++){
var _a3=this.items[i][0];
var url=this.items[i][1];
var _a5=this.items[i][2];
this.h.ml[_a3]=url;
var cn=(_a0==_a3?"selected":"");
cn=(cn!=""?"class=\""+cn+"\"":"");
s.push("<td nowrap "+cn);
s.push("id=\""+_a3+".mouseover\" ");
s.push("><a ");
s.push("title=\""+_a5+"\" ");
s.push("href=\""+url+"\">"+_a5+"</a>");
if(this.allowClickTrigger()){
s.push("<a ");
s.push("id=\""+_a3+".click\" ");
...
var _a7=mb.cookie.get(this.COOKIE_SIDEBAR);
_a7=(_a7||"1");
this.toggle((_a7=="1"));
mb.log.exit();
};
this.toggle=function(_a8){
mb.log.enter(this.GID,"toggle");
var el;
if((el=mb.ui.get(this.ID_SIDEBAR))!=null){
_a8=(_a8||(el.style.display=="none"));
if(el){
el.style.display=(_a8?"":"none");
el.style.width=(_a8?"140px":"0px");
}
if((el=mb.ui.get(this.ID_CONTENT))!=null){
el.style.width="100%";
}
if((el=mb.ui.get(this.ID_SHOW))!=null){
el.style.display=(_a8?"none":"inline");
}
if((el=mb.ui.get(this.ID_HIDE))!=null){
el.style.display=(_a8?"inline":"none");
}
mb.cookie.set(this.COOKIE_SIDEBAR,(_a8?"1":"0"),365);
}else{
...
this.activateMenuItem=function(id,_ac){
if(this.stateChangeTimer[id]!=null){
clearTimeout(this.stateChangeTimer[id]);
}
this.clear();
this.openTimer=setTimeout("mb.topmenu.activateMenuItem('"+id+"', "+_ac+");",this.activateTime);
this.stateChangeTimer[id]=setTimeout("mb.topmenu.timer.onStateChange('"+id+"', "+_ac+");",this.stateChangeTime);
};
this.onStateChange=function(id,_ae){
this.stateChangeTimer[id]=null;
mb.topmenu.mouseOver(id,_ae);
};
...
this.unscaleAlbumArt=function(_af){
...
if(!(w=_af.naturalWidth)||!(h=_af.naturalHeight)){
return mb.log.exit();
}
var _b1=200,max_h=200;
if(w>_b1||h>max_h){
var _b2=w/_b1,scale_h=h/max_h;
if(_b2>scale_h){
w/=_b2;
h/=_b2;
}else{
...
var obj;
if((obj=_af.parentNode.nextSibling)!=null){
...
var _b4=document.images;
var cnt=0;
for(var i=_b4.length-1;i>=0;i--){
var _b7=_b4[i];
if(_b7.className=="amazon_coverart"&&_b7.complete){
this.unscaleAlbumArt(_b7);
cnt++;
}
}
...
mb.registerDOMReadyAction=function(_b9){
mb.log.enter(mb.GID,"registerDOMReadyAction");
if(_b9 instanceof MbEventAction){
mb.onDomReadyActions.push(_b9);
}else{
mb.log.error("Invalid argument, expected MbEventAction: $",_b9);
}
mb.log.exit();
};
...
mb.runRegisteredFunctions=function(_ba){
var i=0,len=_ba.length;
if(len>0){
...
mb.log.error("Invalid object, expected MbEventAction: $",_bc);
}
}while(len>++i);
}
};
