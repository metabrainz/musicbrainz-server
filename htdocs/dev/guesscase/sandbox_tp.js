...
function TrackParserTest() {
	...
	this.testCases = [
		new TrackParserCases(
			...
			[
			new TrackParserPage('discogs.com', 'Featuring artists',
			...
			new TrackParserPage('amazon.de', 'Plain tracklisting',
				'1. Spitfire        \n2. Girls        \n3. Memphis Bells        \n4. Get Up Get Off        \n5. Hot Ride        \n6. Wake Up Call        \n7. Action Radar        \n8. Medusa\'s Path        \n9. Phoenix        \n10. You\'ll Be Under My Wheels        \n11. Way It Is        \n12. Shootdown        \n13. More Girls [*]     \n'
			),
			new TrackParserPage('amazon.com', 'With listen links',
		...
		new TrackParserCases(
			...
			[
			new TrackParserPage( 'discogs.com', 'Vinyl numbering scheme<br/>&raquo; Mark the checkbox \'Detect Vinyl track numbers\' in the TrackParser UI',
		...
		new TrackParserCases(this.sa,
			...
			[
			new TrackParserPage('babyblaue-seiten.de', 'No brackets around the track times',
		...
		new TrackParserCases(this.sa,
		   ...
		   [
			...
			new TrackParserPage('discogs.com', 'Additional info, ACT information',
		...
		new TrackParserCases(this.va,
			...
			'Factor E',
			[
			new TrackParserPage('Discogs', 'Artist-Tracktitle separated by 2xWhiteSpace',
		...
		new TrackParserCases(this.va,
			...
			[
			new TrackParserPage('amazon.com', 'Artist-Tracktitle separated by \' - \'',
		...
		new TrackParserCases(this.va,
			...
			'Schattenreich Vol.2',
			[
			new TrackParserPage('amazon.com', 'Artist with hyphens',
			...
			new TrackParserPage('amazon.com', 'Unicode, Hyphens and Slashes mixed',
	...
	/**
	 * Returns the html code for the different test cases.
	 *
	 * @param isVa	if the tests for various- or single artist
	 *				releases should be rendered.
	 */
	this.getUI = function(isVA) {
		var s = [];
	...
	/**
	 * Toggle this visibility of the trackparser tests
	 */
	this.setVisible = function() {
		var obj;
		if ((obj = mb.ui.get("testlist")) != null) {
	...
	this.onRunTest = function(i,j) {
		...
		var obj = null;
		if ((obj = mb.ui.get(es.tp.TRACKSAREA)) != null) {
			var tc = this.testCases[i];
