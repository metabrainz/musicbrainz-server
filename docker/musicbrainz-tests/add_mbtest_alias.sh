...
# The mbtest.local hostname is added for the Selenium proxy in t/selenium.mjs:
...
#    point still holds.)
echo '127.0.0.1 mbtest.local' >> /etc/hosts

# For BETA_REDIRECT_HOSTNAME
echo '127.0.0.1 mbtest-beta.local' >> /etc/hosts
