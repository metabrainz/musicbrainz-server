...
our @EXPORT_OK = (
    ...
    qw(
        ...
        $ANON_ARTIST_GID $ANON_ARTIST_ID
        $DATA_ARTIST_GID $DATA_ARTIST_ID
        $DIALOGUE_ARTIST_GID $DIALOGUE_ARTIST_ID
        $NO_ARTIST_GID $NO_ARTIST_ID
        $TRAD_ARTIST_GID $TRAD_ARTIST_ID
        $UNKNOWN_ARTIST_GID $UNKNOWN_ARTIST_ID
        @SPECIAL_ARTIST_GIDS @SPECIAL_ARTIST_IDS
        $NOLABEL_ID $NOLABEL_GID
...
Readonly our $ANON_ARTIST_GID => 'f731ccc4-e22a-43af-a747-64213329e088';
Readonly our $ANON_ARTIST_ID => 15071;

Readonly our $DATA_ARTIST_GID => '33cf029c-63b0-41a0-9855-be2a3665fb3b';
Readonly our $DATA_ARTIST_ID => 41744;

Readonly our $DIALOGUE_ARTIST_GID => '314e1c25-dde7-4e4d-b2f4-0a7b9f7c56dc';
Readonly our $DIALOGUE_ARTIST_ID => 92121;

Readonly our $NO_ARTIST_GID => 'eec63d3c-3b81-4ad4-b1e4-7c147d4d2b61';
Readonly our $NO_ARTIST_ID => 105725;

Readonly our $TRAD_ARTIST_GID => '9be7f096-97ec-4615-8957-8d40b5dcbc41';
Readonly our $TRAD_ARTIST_ID => 762646;

Readonly our $UNKNOWN_ARTIST_GID => '125ec42a-7229-4250-afc5-e057484327fe';
Readonly our $UNKNOWN_ARTIST_ID => 97546;

Readonly our @SPECIAL_ARTIST_GIDS => (
    $VARTIST_GID,
    $ANON_ARTIST_GID,
    $DATA_ARTIST_GID,
    $DIALOGUE_ARTIST_GID,
...
Readonly our @SPECIAL_ARTIST_IDS => (
    $DARTIST_ID,
    $VARTIST_ID,
    $ANON_ARTIST_ID,
    $DATA_ARTIST_ID,
...
Readonly our $EDITOR_SANITISED_COLUMNS => join(', ',
    ...
    'editor.name',
    '0 AS privs',
    q('editor-' || editor.id || '@musicbrainz.invalid' AS email),
    'NULL AS website',
    'NULL AS bio',
    'editor.member_since',
