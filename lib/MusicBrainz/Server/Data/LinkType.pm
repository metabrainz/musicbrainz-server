...
Returns an array of strings containing all the relatable entity pairs that
have at least one relationship type, in the form "entitytype0-entitytype1"
...
sub get_entity_pairs_with_relationship_types {
    ...
    my @result;
    for my $row (@$rows) {
        push @result, $row->{entity_type0} . '-' . $row->{entity_type1};
    }
