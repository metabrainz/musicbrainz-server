package MusicBrainz::Server::Report::RecordingsPossiblyAssignedToTheWrongArtist;
use Moose;
...
sub query {
    # Find all recordings with the same name that have artists with the same name.
    "
    SELECT
        recording_id,
